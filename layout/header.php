...
<head>
    ...
    <!-- favicon -->
    <link href="assets-template/dist/img/favicon.png" rel="icon">
    <link href="assets-template/dist/img/favicon.png" rel="apple-touch-icon">
</head>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                <img src="assets-template/dist/img/favicon.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Kiaramas Bus</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets-template/dist/img/me.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
